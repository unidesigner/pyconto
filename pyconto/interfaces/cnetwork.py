...
class Network(HasTraits):
    ...
    rmanager = Instance(RenderManager)
        ...
        if value:
            ...
            if self.rmanager is None:
                ...
                if len(self.surfaces) == 0:
                    ...
                    self.rmanager.datasourcemanager._compute_3DLayout(-1, -1)
                    self.rmanager.visualize_graph()
                else:
            ...
            mlab.close(self.rmanager.scene3d)
            #self.rmanager.close_scenes()
    ...
    def _edge_parameters(self):
        ...
        if self._edge_para is None:
            self._edge_para = EdgeParameters(self, self.rmanager.attract.point_scalars_name)
    ...
    def _create_renderer(self):
        ...
        if self.active:
            if self.rmanager is None:
                ...
                self.rmanager = RenderManager(network=self)
            else:
    ...
    def _render_matrix(self):
        ...
        self.rmanager.invoke_matrix_viewer()
    ...
    def unselect_all(self):
        ...
        self.rmanager._select_nodes(selection_node_array = array(graphnodes))
    ...
    def select_all(self):
        ...
        self.rmanager._select_nodes(selection_node_array = array(graphnodes), activate = True)
    ...
    def set_selectiongraph(self, sellist, activate = False):
        ...
        self.rmanager._select_nodes(selection_node_array = array(tmparr, dtype = int16), activate = activate)
    ...
    def toggle_surface(self):
        ...
        if self.rmanager is None:
            raise Exception('No RenderManager. You have to first activate the network and render it.')
        self.rmanager._toggle_surface()
        
    def show_surface(self):
        """ Shows the surface for the selected network nodes """
        if self.rmanager is None:
            raise Exception('No RenderManager. You have to first activate the network and render it.')
        self.rmanager._show_surface()
